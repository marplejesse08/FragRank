...
function cleanActivityFileName(name = 'media') {
  return name
    .replace(
      /[^a-zA-Z0-9._-]/g,
      '-'
...
function activityMediaKind(mediaType = '') {
  const lower =
...
function activityMediaPathFromUrl(url) {
  if (!url) return null;
...
function TournamentsPage({
  ...
  function isJoined(tournamentId) {
